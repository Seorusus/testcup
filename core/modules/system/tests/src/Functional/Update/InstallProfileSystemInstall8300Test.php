...
class InstallProfileSystemInstall8300Test extends UpdatePathTestBase {
  ...
  public function testUpdate() {
    // Ensure the BC layers work and _settings.php and configuration is in the
    // expected state before updating.
    $this->assertEqual('standard', \Drupal::installProfile());
    $this->assertEqual('standard', Settings::get('install_profile'), 'The install profile has not been written to _settings.php.');
