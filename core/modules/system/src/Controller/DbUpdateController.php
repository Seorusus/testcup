...
class DbUpdateController extends ControllerBase {
  ...
  protected function results(Request $request) {
    ...
    if (Settings::get('update_free_access')) {
      $message .= '<p>' . $this->t("<strong>Reminder: don't forget to set the <code>\$settings['update_free_access']</code> value in your <code>_settings.php</code> file back to <code>FALSE</code>.</strong>") . '</p>';
    }
