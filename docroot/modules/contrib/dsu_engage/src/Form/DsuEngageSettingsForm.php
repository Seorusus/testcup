...
class DsuEngageSettingsForm extends ConfigFormBase {
  ...
  private function buildFieldsSettingsFrom() {
    ...
    $fields = [
      ...
      8 => ['name' => 'field_best_before_date', 'label' => 'Best before date'],
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('dsu_engage_password_expiration: @password_expiration ', ['@password_expiration' => $passwordExpiration]));
    $config->set('dsu_engage_password_expiration', $passwordExpiration)->save();
  }
}
